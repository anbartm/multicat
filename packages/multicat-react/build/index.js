...
exports.Provider = exports.withMulticat = undefined;

var _withMulticat2 = __webpack_require__(5);

var _withMulticat3 = _interopRequireDefault(_withMulticat2);

var _Provider2 = __webpack_require__(11);

var _Provider3 = _interopRequireDefault(_Provider2);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.withMulticat = _withMulticat3.default;
...
var withMulticat = function withMulticat(Component) {
  var C = function C(props, context) {
    var wrappedComponentRef = props.wrappedComponentRef,
        remainingProps = _objectWithoutProperties(props, ["wrappedComponentRef"]);

    var multicatEvent = context.multicatEvent,
        multicatView = context.multicatView;
  ...
  C.contextTypes = {
    multicatEvent: _propTypes2.default.func,
    multicatView: _propTypes2.default.func
  };

  return (0, _hoistNonReactStatics2.default)(C, Component);
};

exports.default = withMulticat;
...
var _multicat = __webpack_require__(12);

var _multicat2 = _interopRequireDefault(_multicat);
...
var Provider = function (_PureComponent) {
  ...
  function Provider() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Provider.__proto__ || Object.getPrototypeOf(Provider)).call.apply(_ref, [this].concat(args))), _this), _this.getChildContext = function () {
      return {
        multicatEvent: _this.multicatEvent,
        multicatView: _this.multicatView
      };
    }, _this.multicatEvent = function (event, properties) {
      _this.multicat.event(event, properties);
    }, _this.multicatView = function (pathname) {
      _this.multicat.view(pathname);
  ...
  _createClass(Provider, [{
    ...
    value: function componentWillMount() {
      ...
      this.multicat = new _multicat2.default(config);
    }
  }, {
    key: 'render',
...
var log = function log() {
  ...
  if (isDevelopment || window.MULTICAT_LOGGING) {
    ...
    (_console = console).log.apply(_console, ['Multicat'].concat(msgs));
  }
};

var Multicat = function () {
  _createClass(Multicat, [{
    key: 'event',
  ...
  function Multicat(config) {
    _classCallCheck(this, Multicat);
